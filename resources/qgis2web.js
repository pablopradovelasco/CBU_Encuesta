...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [789535.015902, 8067205.951810, 813581.232549, 8080893.559997], maxZoom: 27, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32719',
...
map.getView().fit([789535.015902, 8067205.951810, 813581.232549, 8080893.559997], map.getSize());
